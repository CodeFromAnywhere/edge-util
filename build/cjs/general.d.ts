 ...
 */
export declare const apply: <T extends unknown>(functions: ((input: T) => T)[], value: T) => T;
/**
 ...
 */
export declare const makeArray: <T extends unknown>(...arrayOrNotArray: (T | T[] | undefined)[]) => T[];
/**
 * takes any type T or an array of T and returns T or the first of the array (which is T)
 */
export declare const takeFirst: <T extends unknown>(arrayOrNot: T | T[]) => T;
/**
