 ...
 */
type ModelConfigKeys<T extends ModelConfig, U extends keyof ModelConfig> = T[U] extends readonly string[] ? T[U][number] : never;
/**
 ...
 * ```
 */
export type ModelConfigFilterObject<T extends ModelConfig, U extends "indexKeys" | "pathIndexKeys"> = GetFilterObject<ModelConfigKeys<T, U>>;
export type ModelIndexKeyEnum<T extends ModelConfig> = ModelConfigKeys<T, "indexKeys">;
export type CreateOrmItem<TModel extends {
    [key: string]: any;
}> = MakeOptional<TModel, keyof OrmItem>;
export {};
