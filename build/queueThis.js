 ...
 */
var queueThis = function (fn, maxConcurrency) {
    var parameters = [];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(isRunning[name] >= maxConcurrency)) return [3 /*break*/, 2];
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, fn.apply(void 0, __spreadArray([], __read(parameters), false))];
                case 4:
                    result = _a.sent();
                    isRunning[name]--;
